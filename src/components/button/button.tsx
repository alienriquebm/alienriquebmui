...
export function Button({
  ...
  const buttonClasses = cn(
    'active:select-none whitespace-nowrap border border-blue-500 h-[52px] flex gap-1 items-center justify-center font-bold px-4 text-white bg-blue-500 hover:bg-blue-300 hover:border-blue-300 uppercase transition-all ease-out duration-200 tracking-wide text-base rounded-lg active:outline-none focus:outline-none focus-visible:outline-none',
    ...
    size === 'small' && 'h-8 text-xs rounded-md',
    className,
  );
